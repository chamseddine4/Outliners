 ...
 */
final class Version20220220140933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, nom_sur_carte VARCHAR(255) NOT NULL, num_carte INT NOT NULL, mois_exp VARCHAR(255) NOT NULL, annee_exp INT NOT NULL, cvv INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
